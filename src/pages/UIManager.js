      ...
      >
        ...
        >
          ...
          >
            ...
            <Menu.Item key="1" onClick={() => handleNavigate(<Sell />)}>
              Bán hàng
            </Menu.Item>
            <Menu.Item
              key="2"
              onClick={() => handleNavigate(<BillManagement />)}
            >
              Hóa đơn bán hàng
            </Menu.Item>
          </SubMenu>
          ...
          >
            <Menu.Item key="3" onClick={() => handleNavigate(<ProductPage />)}>
              Danh sách sản phẩm
            </Menu.Item>
            <Menu.Item key="4" onClick={() => handleNavigate(<PriceProduct />)}>
              Bảng giá
            </Menu.Item>
          </SubMenu>
          ...
          <SubMenu key="sub3" icon={<TeamOutlined />} title="Quản lí nhân viên">
            <Menu.Item
              key="5"
              onClick={() => handleNavigate(<ManageEmployees />)}
            >
              Danh sách nhân viên
            </Menu.Item>
          </SubMenu>
          ...
          >
            <Menu.Item key="6" onClick={() => handleNavigate(<CustomerList />)}>
              Danh sách khách hàng
            </Menu.Item>
          </SubMenu>

          <SubMenu key="sub4" icon={<InboxOutlined />} title="Quản lí kho">
            <Menu.Item key="8" onClick={() => handleNavigate(<NhapKho />)}>
              Quản lí nhập kho
            </Menu.Item>
            <Menu.Item key="9" onClick={() => handleNavigate(<StockList />)}>
              Tồn kho
            </Menu.Item>
            <Menu.Item
              key="11"
            ...
            <Menu.Item key="10" onClick={() => handleNavigate(<Transaction />)}>
              Giao dịch
            </Menu.Item>
          </SubMenu>
          ...
          >
            <Menu.Item
              key="12"
              onClick={() => handleNavigate(<SuppliersInfo />)}
            >
          ...
          >
            <Menu.Item
              key="14"
              onClick={() => handleNavigate(<PromotionProgramList />)}
            >
          ...
          <SubMenu key="sub7" icon={<EyeOutlined />} title="Theo dõi đơn hàng">
            <Menu.Item
              key="16"
              onClick={() => handleNavigate(<OrderTracking />)}
            >
              Theo dõi đơn hàng
            </Menu.Item>
            <Menu.Item key="17" onClick={() => handleNavigate()}>
              Báo cáo sản phẩm
            </Menu.Item>
          </SubMenu>
          ...
          <SubMenu key="sub8" icon={<LineChartOutlined />} title="Thống kê">
            <Menu.Item
              key="18"
              onClick={() => handleNavigate(<StatisticsChart />)}
            >
              Báo cáo doanh thu
            </Menu.Item>
            <Menu.Item
              key="19"
              onClick={() => handleNavigate(<CustomerReport />)}
            >
              Báo cáo khách hàng
            </Menu.Item>
            <Menu.Item
              key="20"
              onClick={() => handleNavigate(<PromotionReport />)}
            >
              Thống kê khuyến mãi
            </Menu.Item>
          </SubMenu>
