...
const API_URL = "https://bemartshop.onrender.com/api";
...
export const verifyOTP = async (data) => {
  return new Promise((reject, resolve) => {
    axios
      .post(`${API_URL}/auth/verify-otp`, data, config)
      .then((res) => {
        reject(res);
      })
      .catch((err) => {
...
export const updateUserRole = async (userId, newRole) => {
  try {
    const response = await axios.patch(
      `${API_URL}/auth/users/update-role/${userId}`,
      { role: newRole }
    );
    return response.data;
  } catch (error) {
...
export const getProductsBySupplier = async (supplierId) => {
  try {
    const response = await axios.get(
      `${API_URL}/warehouses/supplier/${supplierId}`,
      config
    );
...
// Tạo mới ncc
export const addToCartForUser = async (
  userId,
  productId,
  quantity,
  currentPrice,
...
export const getShipperCart = async (userId) => {
  try {
    const response = await axios.get(
      `${API_URL}/cart/shipper?userId=${userId}`,
      config
    );
    return response.data;
  } catch (error) {
...
export const getDamuaCart = async (userId) => {
  try {
    const response = await axios.get(
      `${API_URL}/cart/damua?userId=${userId}`,
      config
    );
    return response.data;
  } catch (error) {
...
export const getHoanTraCart = async (userId) => {
  try {
    const response = await axios.get(
      `${API_URL}/cart/hoantra?userId=${userId}`,
      config
    );
    return response.data;
  } catch (error) {
...
export const updateCart = async (cartId, status, userId) => {
  //userID là id người thay đổi giỏ hàng - nhân viên
  try {
    console.log("Thông tin gửi đến:", { cartId, status, userId });
    const response = await axios.put(
      `${API_URL}/cart/update`,
      { cartId, status, userId },
      config
    );
    return response.data;
  } catch (error) {
...
export const getBillsByUser = async (userId) => {
  try {
    const response = await axios.get(`${API_URL}/bill/user`, {
      params: { userId },
    });
    return response.data;
  } catch (error) {
...
export const getBillsByStatus = async (status) => {
  try {
    const response = await axios.get(`${API_URL}/bill/status`, {
      params: { status },
    });
    return response.data;
  } catch (error) {
...
export const updateBillStatus = async (billId, status) => {
  try {
    const response = await axios.patch(`${API_URL}/bill/update`, {
      billId,
      status,
    });
    return response.data;
...
export const addPromotion = async (promotionData) => {
  try {
    ...
    console.error(
      "Lỗi khi thêm chương trình khuyến mãi:",
      error.response?.data || error.message
    );
    throw error;
  }
...
export const updatePromotion = async (promotionId, promotionData) => {
  try {
    ...
    console.error(
      `Lỗi khi cập nhật chương trình khuyến mãi với ID ${promotionId}:`,
      error.response?.data || error.message
    );
    throw error;
  }
...
export const deletePromotion = async (promotionId) => {
  try {
    ...
    console.error(
      `Lỗi khi xóa chương trình khuyến mãi với ID ${promotionId}:`,
      error.response?.data || error.message
    );
    throw error;
  }
